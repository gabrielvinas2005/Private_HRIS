    ...
    <MainLayout>
      ...
      <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Profile & Records Card -->
          <div 
            v-if="menuAccessLoaded && canViewEmployeeRecord"
            @click="navigateTo201File()"
            class="group bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-blue-300 transition-all duration-200 cursor-pointer"
          >
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h3 class="font-semibold text-gray-900">My Profile & Records</h3>
                <p class="text-gray-600 text-sm">Manage your employment records</p>
              </div>
            </div>
          </div>
          ...
          <div 
            v-if="menuAccessLoaded && canViewLeave"
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600 text-sm">Submit and track leave requests</p>
              </div>
            </div>
          </div>
          ...
          <div 
            v-if="menuAccessLoaded && canViewOvertime"
            @click="navigateToModule('overtime-scheduling')"
            class="group bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-orange-300 transition-all duration-200 cursor-pointer"
          >
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h3 class="font-semibold text-gray-900">Overtime Management</h3>
                <p class="text-gray-600 text-sm">Manage overtime applications</p>
              </div>
            </div>
          </div>
          ...
          <!-- Payslip Card -->
          <div 
            v-if="menuAccessLoaded && canViewPayslip"
            @click="navigateToModule('payroll-compensation')"
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h3 class="font-semibold text-gray-900">Payslip</h3>
                <p class="text-gray-600 text-sm">View and download payslips</p>
              </div>
            </div>
          </div>
          ...
          <!-- DTR Card -->
          <div 
            v-if="menuAccessLoaded && canViewDtr"
            @click="navigateToModule('dtr')"
            class="group bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-indigo-300 transition-all duration-200 cursor-pointer"
          >
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h3 class="font-semibold text-gray-900">Daily Time Record</h3>
          ...
          <!-- SALN Card -->
          <div 
            v-if="menuAccessLoaded && canViewSaln"
            @click="navigateToModule('saln')"
            class="group bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-teal-300 transition-all duration-200 cursor-pointer"
          >
            <div class="flex items-center space-x-3">
              <div class="w-12 h-12 bg-teal-100 rounded-lg flex items-center justify-center group-hover:bg-teal-200 transition-colors duration-200">
                <svg class="w-6 h-6 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
              </div>
              <div>
                <h3 class="font-semibold text-gray-900">SALN</h3>
                <p class="text-gray-600 text-sm">Submit your SALN</p>
              </div>
            </div>
          </div>
        </div>
